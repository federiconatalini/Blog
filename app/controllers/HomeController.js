class HomeController {
    ...
    getPost() {
        this.restController.get('https://texty-89895.firebaseio.com/posts.json', function (data, textStatus, jqXHR) {
            for (let id in data) {
    ...
    newPost(post) {
        ...
        this.restController.post("https://texty-89895.firebaseio.com/posts.json", JSON.stringify(data), function (data, status, xhr) {
            this.showPost();
        }.bind(this))
    }
